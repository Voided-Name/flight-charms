    ...
    <div class="position-relative iq-banner">
      ...
      <div class="iq-navbar-header" style="height: 215px;">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="flex-wrap d-flex justify-content-between align-items-center">
                ...
                <div>
                  <a href="<?= Flight::request()->base ?>/announcements" class="btn btn-link btn-soft-light">
        ...
        <div class="iq-header-img">
          <img src="<?= Flight::request()->base ?>/assets/img/dashboard/top-header.png" alt="header" class="theme-color-default-img img-fluid w-100 h-100 animated-scaleX">
        </div>
      </div>
