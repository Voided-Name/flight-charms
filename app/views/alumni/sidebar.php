...
?>
  " href="<?= Flight::request()->base ?>/dashboard/alumni/awards">
                <i class="icon">
...
?>
  " href="<?= Flight::request()->base ?>/dashboard/alumni/workExp">
            ...
            <li class="nav-item">
              <a class="nav-link 
<?php
if ($_SESSION['alumniPage'] == "genResume") {
  echo "active";
}
?>
  " href="<?= Flight::request()->base ?>/dashboard/alumni/generateResume">
                <i class="icon">
                ...
                <span class="item-name">Generate Resume</span>
              </a>
            </li>
          </ul>
        </li>
...
?>
  " aria-current="page" href="<?= Flight::request()->base ?>/dashboard/alumni/allVacancies">
            <i class="icon">
        ...
        <li class="nav-item">
          <a class="nav-link 
<?php
if ($_SESSION['alumniPage'] == "applications") {
  echo "active";
}
?>
  " aria-current="page" href="<?= Flight::request()->base ?>/dashboard/alumni/allVacancies">
