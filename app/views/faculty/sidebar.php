...
?>
  " aria-current="page" href="<?= Flight::request()->base ?>/dashboard/faculty/">
            <i class="icon">
  ...
  <a class="nav-link
    ...
    ?> 
      " href="<?= Flight::request()->base ?>/dashboard/faculty/postAnnouncement">
                <i class="icon">
    ...
    ?> 
      " href="<?= Flight::request()->base ?>/dashboard/faculty/postAnnouncementManage">
                <i class="icon">
...
?>
    " href="manage-profile.php">
        ...
        <li class="nav-item">
          <a class="nav-link 
<?php
if ($_SESSION['facultyPage'] == "vacancies") {
  echo "active";
}
?>
  " aria-current="page" href="<?= Flight::request()->base ?>/dashboard/faculty/allVacancies">
            <i class="icon">
              <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
