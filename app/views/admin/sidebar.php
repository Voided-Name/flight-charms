<aside id="sidebar" class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
  <div class="sidebar-header d-flex align-items-center justify-content-start">
    <a href="<?= Flight::request()->base ?>/dashboard/admin" class="navbar-brand">
...
?>
  " aria-current="page" href="<?= Flight::request()->base ?>/dashboard/admin">
            <i class="icon">
        ...
        <li class="nav-item">
          ...
          <ul class="sub-nav collapse ms-2" id="horizontal-menu" data-bs-parent="#sidebar-menu">
            <li class="nav-item">
              <a class="nav-link 
<?php
if ($_SESSION['adminPage'] == "validate") {
  echo "active";
} ?>
  " href="<?= Flight::request()->base ?>/dashboard/admin/validate">
                <i class="icon">
...
<?php
if ($_SESSION['adminPage'] == "list") {
  echo "active";
} ?>

" href="<?= Flight::request()->base ?>/dashboard/admin/list">
                <i class="icon">
            ...
            <li class="nav-item">
              <a class="nav-link 
<?php
if ($_SESSION['adminPage'] == "create") {
  echo "active";
} ?>

" href="<?= Flight::request()->base ?>/dashboard/admin/create">
                <i class="icon">
        ...
        <li class="nav-item">
          <a class="nav-link 
<?php
if ($_SESSION['adminPage'] == "vacancies") {
  echo "active";
}
?>
  " aria-current="page" href="<?= Flight::request()->base ?>/dashboard/admin/allVacancies">
            <i class="icon">
        ...
        <li class="nav-item">
          <a class="nav-link 
<?php
if ($_SESSION['adminPage'] == "generate") {
  echo "active";
}
?>

  " aria-current="page" href="<?= Flight::request()->base ?>/dashboard/admin/generate">
            <i class="icon">
              <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
